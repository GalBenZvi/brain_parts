...
FILES_QUERY_TO_NATIVE_NAMING_EDGES = [("anatomical_reference", "reference")]

#: Apply Transform
INPUT_TO_APPLY_TRANSFORM_EDGES = [("parcellation_image", "input_image")]
...
#: Probseg to mask
INPUT_TO_THRESHOLD_EDGES = [("probability_masking_threshold", "thresh")]
FILES_QUERY_TO_THRESHOLD_EDGES = [("gm_probability", "in_file")]
